...
/* harmony export (immutable) */ __webpack_exports__["getSubmissionInfo"] = getSubmissionInfo;
/* harmony export (immutable) */ __webpack_exports__["getSubmissionCritiques"] = getSubmissionCritiques;
/* harmony export (immutable) */ __webpack_exports__["getRemarks"] = getRemarks;
/* harmony export (immutable) */ __webpack_exports__["postRemark"] = postRemark;
/* harmony export (immutable) */ __webpack_exports__["patchRemark"] = patchRemark;
/* harmony export (immutable) */ __webpack_exports__["deleteRemark"] = deleteRemark;
/* harmony export (immutable) */ __webpack_exports__["incrementRemark"] = incrementRemark;
/* harmony export (immutable) */ __webpack_exports__["getIncome"] = getIncome;
/* harmony export (immutable) */ __webpack_exports__["getActiveReview"] = getActiveReview;
/* harmony export (immutable) */ __webpack_exports__["runRecurring"] = runRecurring;
...
function getSubmissionInfo(data, axiosInstance, sendResponse) {
  axiosInstance({
    method: 'get',
...
function getSubmissionCritiques(data, axiosInstance, sendResponse) {
  axiosInstance({
    method: 'get',
...
function getRemarks(data, axiosInstance, sendResponse) {
  axiosInstance({
    method: 'get',
    url: '/remarks/all/',
...
function postRemark(data, axiosInstance, sendResponse) {
  axiosInstance({
    method: 'post',
    url: '/remarks/' + data.remarkType + '/',
    data: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, data.remark, {
      project_name: data.projectName
    })
  }).then(sendResponse, sendResponse);
}

function patchRemark(data, axiosInstance, sendResponse) {
  axiosInstance({
    method: 'patch',
...
function deleteRemark(data, axiosInstance, sendResponse) {
  axiosInstance({
    method: 'delete',
    url: '/remarks/' + data.remarkType + '/' + data.remark.id + '/'
  }).then(sendResponse, sendResponse);
...
function incrementRemark(data, axiosInstance, sendResponse) {
  axiosInstance({
    method: 'post',
...
function getIncome(axiosInstance) {
  var now = new Date();
...
function getActiveReview(axiosInstance) {
  axiosInstance({
    method: 'get',
    baseURL: 'https://review-api.udacity.com/api/v1',
    ...
    var activeReview = response.data[0];
    chrome.storage.local.set({ activeReview: activeReview });
    chrome.browserAction.setBadgeText({ text: String(response.data.length) });
  });
}

function runRecurring(data, axiosInstance) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__requests__ = __webpack_require__(195);
